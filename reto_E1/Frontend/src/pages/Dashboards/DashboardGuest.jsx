  ...
  return (
    <div className="bg-[#2A2A2A] min-h-screen text-white">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 px-10 py-16">
        {[
          { value: "50%",  label: "Demo Completion" },
          { value: "Lv.1", label: "Security Awareness" },
          { value: "3",    label: "Featured Simulations" },
          { value: "13",   label: "Available Trainings" },
        ].map((k) => (
      ...
      <section className="grid grid-cols-1 xl:grid-cols-2 gap-8 px-10 pb-16">
        <div className="bg-[#1A1A1A] rounded-2xl p-8 border border-[#333]">
          <h3 className="text-2xl font-bold mb-8 text-center">Cybersecurity Awareness</h3>
        ...
        <div className="bg-[#1A1A1A] rounded-2xl p-8 border border-[#333]">
          <h3 className="text-2xl font-bold mb-10 text-center">Popular Simulations</h3>
