  ...
  return (
    <div className="bg-[#2A2A2A] min-h-screen text-white">
      ...
      <section className="pt-32 pb-16 text-center px-10 bg-[#1A1A1A]">
        <p className="text-[#CD163F] text-sm font-semibold tracking-widest uppercase mb-3">Admin Panel</p>
        <h2 className="text-5xl font-bold">Admin Analytics Dashboard</h2>
        <p className="text-gray-400 mt-4 text-lg">Full system overview — users, performance, and platform metrics.</p>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 px-10 py-16">
        {[
          ...
          { value: "2.5k",  label: "Games Played" },
          { value: "1,000", label: "Average Score" },
          { value: "13",    label: "Errors Detected" },
        ].map((k) => (
      ...
      <section className="grid grid-cols-1 xl:grid-cols-2 gap-8 px-10 pb-16">
        <div className="bg-[#1A1A1A] rounded-2xl p-8 border border-[#333]">
          <h3 className="text-2xl font-bold mb-8 text-center">Performance by Scenario</h3>
          <div className="flex items-end justify-center gap-8 h-[250px]">
            <div className="flex flex-col items-center gap-2">
              <div className="w-20 bg-[#CD163F] h-[200px] rounded-t-lg"></div>
              <span className="text-gray-400 text-sm">Scenario 1</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="w-20 bg-[#790A23] h-[120px] rounded-t-lg"></div>
              <span className="text-gray-400 text-sm">Scenario 2</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="w-20 bg-[#4A0515] h-[60px] rounded-t-lg"></div>
              <span className="text-gray-400 text-sm">Scenario 3</span>
            </div>
          </div>
        </div>

        <div className="bg-[#1A1A1A] rounded-2xl p-8 border border-[#333]">
          <h3 className="text-2xl font-bold mb-10 text-center">User Distribution</h3>
          <div className="space-y-6">
            {[
              { label: "Clients",   pct: "40%", color: "bg-[#CD163F]", w: "w-[40%]" },
              { label: "Employees", pct: "35%", color: "bg-[#790A23]", w: "w-[35%]" },
              { label: "Guests",    pct: "25%", color: "bg-[#4A0515]", w: "w-[25%]" },
            ].map((b) => (
              <div key={b.label}>
      ...
      <section className="flex flex-wrap justify-center gap-6 pb-16 px-10">
        <button className="bg-[#CD163F] hover:bg-[#a80f32] transition px-10 py-4 rounded-2xl text-xl font-bold">Manage Users</button>
        <button className="bg-[#1A1A1A] border border-[#444] hover:border-[#CD163F] transition px-10 py-4 rounded-2xl text-xl font-bold">Export Reports</button>
      </section>
